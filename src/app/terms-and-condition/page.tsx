    ...
    <section>
      ...
      <section className="flex flex-col gap-4 text-cakkie items-center justify-center lg:max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ol className="text-sm list-disc px-4 md:px-10">
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ol className="italic text-sm list-disc px-4 md:px-10">
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <p className="text-sm">You can’t use Cakkie to:</p>

          <ol className="list-disc px-4 md:px-10 text-sm">
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ul className="list-disc px-4 md:px-10 text-sm">
            <li>
            ...
            <ol className="list-disc px-4 md:md:px-6 text-sm">
              <li>
