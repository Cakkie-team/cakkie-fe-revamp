...
export default function Page() {
  return (
    <>
      <TopNav />
      <section className="flex flex-col gap-4 text-cakkie items-center justify-center max-w-lg xl:max-w-5xl mx-auto p-10">
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ol className="text-sm list-disc px-5 md:px-10">
            <li>
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ol className="italic text-sm list-disc px-5 md:px-10">
            <li>
        ...
        <div className="flex flex-col justify-start items-start gap-4 text-cakkie">
          ...
          <ul className="list-disc px-5 md:px-10 text-sm">
            <li>
