    ...
    <>
      ...
      <div className="flex gap-y-3 flex-wrap w-full justify-start items-start">
        <p className="text-justify leading-6">
          ...
          and commerce within the baking community. The pre-app launch
          activities ensure community involvement and feedback, setting the
          stage for a successful token presale and platform launch.
        </p>
      </div>
    </>
  );
